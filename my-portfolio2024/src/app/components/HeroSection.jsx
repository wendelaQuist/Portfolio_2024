...
const HeroSection = () => {
    ...
    />
                    ...
                    <div>
                        ...
                        <button className="px-2 py-2 w-full sm:w-fit rounded-full bg-[#14121A] text-[#F4DAE2] mt-3 hover:bg-slate-800 hover:text-[#9B7DDE]"><span className="block bg-[#14121A] rounded-full px-1 m-1">Download CV</span></button>
                    </div>
                </div>
